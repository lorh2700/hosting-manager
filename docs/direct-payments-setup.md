...
- 가격 미리보기는 활성 숙소, Beds24 연결, 지정 offer가 필요하다. 필수 요금 포함 여부가 미확인(false/미설정)이면 숙박요금만 표시하고 추가 요금 안내를 붙인다. 최종 결제 견적·시작에는 총액 포함 확인이 여전히 필요하다. 설정 오류나 판매 불가 시 임의 가격을 보여주지 않는다.
