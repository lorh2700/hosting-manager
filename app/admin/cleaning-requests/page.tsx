      ...
      {tab === 'requests' ? (
        ...
        <div className="space-y-4">
          {applications.length === 0 ? (
            ...
            applications.map(app => {
              ...
              const statusColor = app.status === 'approved' ? 'text-green-700 bg-green-50' :
                  ...
                  {isPending && (
                    <div className="flex items-center gap-3 pt-2 border-t border-stone-100">
                      <input
                        ...
                        className="flex-1 bg-white border border-stone-200 px-3 py-2 text-xs text-stone-900 focus:outline-none focus:border-[var(--brand)] focus:ring-2 focus:ring-[var(--brand)]/15"
                      />
                      <button
        ...
        <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <select
                    ...
                    className="w-full bg-white border border-stone-200 px-3 py-2.5 text-sm text-stone-900 focus:outline-none focus:border-[var(--brand)] focus:ring-2 focus:ring-[var(--brand)]/15"
                  >
          ...
          {openCleanings.length === 0 ? (
            ...
            openCleanings.map(c => (
              <div key={c.id} className="bg-white border border-stone-200 p-5">
                <div className="flex items-start justify-between gap-3">
                  <div>
                    ...
                    {c.notes && <p className="text-stone-400 text-xs mt-1">{c.notes}</p>}
                  </div>
